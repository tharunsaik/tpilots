	...
	<div class="container">
		<div class="row text-white">
			<div class="col pt-3">
				...
				<h1 class="font-weight-bold display-1 mb-md-n4 mt-4 pt-4 text-white">Rider</h1>
			</div>
		</div>
	</div>	
</section>
		...
		<main class="col border-left-2 overflow-hidden">
			<section id="WhySVL" class="bg-blue-50 p-5 position-relative">
				<div class="heading-block">
					...
					<h2 class="display-4 text-primary">Why S V L Global</h2>
				</div>
				<header class="pb-5">
					<div class="row align-items-md-center">
						...
						<div class="col-sm-3" uk-parallax="y: -150,0; viewport: 0.4;">
							...
							<div class="card-body">
							<h5 class="card-title t600 color">Lorem ipsum dolor sit</h5>
			...
			<section id="LifeSVL">
				<header class="card rounded-0 border-0 uk-background-cover uk-light text-white bg-black-before before opacity-7-before pt-5" uk-parallax="bgy: -300" style="background-image: url('https://picsum.photos/id/1071/1920/1080');">
					<div class="card-body position-relative pt-5">
						<h2 class="heading text-uppercase text-center mb-5 position-relative">Life @ SVL Global</h2>
						<p>The primary focus of any business is to grow and expand in every sphere and aspect but before that comes the hard work and management. Moreover, apart from satisfying the answer to WHY, it is also necessary to know the WHAT.</p>
						<p>At Techno-Labs, we have developed a program that comes installed with services from many industries. However, endowing quality services, less time and reduced costs are the necessary elements of this program. The program, Fleet management system is a single window solution where the public can be entertained with services from every industry. However, managing the services and partnering is why you should have us onboard.</p>
						<p>Technology is taking steps forward with every second and management of the same is the true need today. We as your partner and service management provider can give a reality check to you. As far as the public satisfaction is concerned, we always believe in customers the first phenomenon.</p>
						<p class="mb-0">With a focused motive to render services from multiple industries, TechnoLabs operate under a fleet management system. The organization's primary concern rests over deriving IT, digital and various other services in a way which does not simply give result oriented outcomes but many other benefits as well. Honoring the time and money of the public, our experts always perform tasks that save both. Be it the corporate training or motor workshops, nothing goes disorganize. Also, our insurance strategies will help the individuals in grabbing the perfect deals along with cashless claim settlements. Overall, the company envisions serving everyone under one service window.</p>
					</div>
				</header>
			</section>
					...
					<div class="row justify-content-start justify-content-sm-center justify-content-md-start">
						<div class="col-lg-4 col-md-6">
							<div class="heading-block services-info pr-1">
								<h2 class="t400 ls0 nott font-primary">Our Core Values</h2>
							...
							<div class="card style-1">
								<div class="card-body px-4 py-5">
									<div class="feature-box media-box">
										...
										<div class="fbox-desc">
											<h3 class="font-size-7 fweight-400">25+ Multiple Languages.</h3>
								...
								<div class="card-body px-4 py-5">
									<div class="feature-box media-box">
										<div class="feature-box media-box">
											...
											<div class="fbox-desc">
												<h3 class="font-size-7">32+ Categories Available.</h3>
												<p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eligendi rem, facilis nobis voluptatum.</p>
												<a href="#" class="btn text-primary mt-4 read-more button-fancy -red">
													<span class="btn-arrow"></span>
													<span class="twp-read-more text">Continue Reading</span>
							...
							<div class="card style-1 border-color-yellow p-2 py-lg-5 px-xl-3 px-lg-2 mt-3 mt-lg-5">
								<div class="card-body rounded">
									<div class="feature-box media-box">
										...
										<div class="fbox-desc">
											<h3 class="font-size-7">On Social Networks.</h3>
											<p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eligendi rem, facilis nobis voluptatum.</p>
											<a href="#" class="btn text-primary mt-4 read-more button-fancy -red">
												<span class="btn-arrow"></span>
												<span class="twp-read-more text">Continue Reading</span>
